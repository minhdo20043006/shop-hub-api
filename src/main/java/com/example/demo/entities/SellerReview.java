...
public class SellerReview implements java.io.Serializable {
	...
	public SellerReview(Account account, SellerProfile sellerProfile, int rating, Date createdAt,
	...
	public SellerReview(Account account, SellerProfile sellerProfile, int rating, String commentReview,
			Date createdAt) {
		this.account = account;
		this.sellerProfile = sellerProfile;
		this.rating = rating;
